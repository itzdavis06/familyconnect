    ...
    <div className="min-h-screen bg-gray-50">
      <header className="mx-auto flex max-w-6xl items-center justify-between px-6 py-6">
        ...
        <nav className="flex items-center gap-4">
          <a href="/login" className="text-sm font-medium text-slate-700">
            ...
            <a href="/register"
            className="rounded-full bg-slate-800 px-5 py-2.5 text-sm font-semibold text-white"
          >
            Get started
          </a>
        </nav>
      ...
      <section className="mx-auto max-w-3xl px-6 py-20 text-center">
        ...
        <p className="mt-4 text-lg text-slate-600">
          ...
          <a href="/register"
          className="mt-8 inline-block rounded-full bg-slate-800 px-6 py-3 text-sm font-semibold text-white"
        >
          Create your family
        </a>
      </section>
      <section className="mx-auto max-w-5xl px-6 py-16">
        <div className="grid gap-6 sm:grid-cols-2">
          <div className="rounded-xl border border-gray-200 bg-white p-6">
            <h3 className="font-bold text-slate-900">Family tree</h3>
            <p className="mt-2 text-sm text-slate-600">
              See how everyone connects, generation by generation.
            </p>
          </div>
          <div className="rounded-xl border border-gray-200 bg-white p-6">
            <h3 className="font-bold text-slate-900">Encrypted chat</h3>
            <p className="mt-2 text-sm text-slate-600">
          ...
          <div className="rounded-xl border border-gray-200 bg-white p-6">
            <h3 className="font-bold text-slate-900">Child profiles</h3>
            <p className="mt-2 text-sm text-slate-600">
